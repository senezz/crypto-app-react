...
export default function SellAllAssetsModal({ asset, open, onClose }) {
  ...
  return (
    <Modal open={open} onCancel={onClose} footer={null} title="Confirm Sell All">
      ...
      <Typography.Paragraph>
        You will receive{' '}
        <Typography.Text strong type="success">${totalValue}</Typography.Text>
      </Typography.Paragraph>
      <Divider />
      <Flex gap="small" justify="flex-end">
        <Button onClick={onClose}>Cancel</Button>
        <Button type="primary" danger onClick={handleConfirm}>Sell All</Button>
      </Flex>
    </Modal>
  )
}